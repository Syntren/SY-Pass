...
Starting with version **2.2.0**, SY-Pass features **Auto-Lock Timeout** for the Master Password vault, **Command Leak Protection** (intercepts `/msg`, `/tell`, etc.), **Anti-Spoofing Hardening** on NeoForge, **Safe Bitwarden Vault Sync**, a dedicated **JUnit 5 Test Suite**, enhanced **Memory Sanitation (`char[]`)**, **Reflection-Proof Storage Protection**, **Universal CSV Import (KeePass, 1Password, Generic)**, and **Configurable Registration Templates & Custom Login Prompts**.
